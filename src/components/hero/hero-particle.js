/*  Hero Particle Component
    Hero Class component that renders colliding particles.
*/
import React, { Component } from 'react'

class HeroParticle extends Component {
  componentDidMount() {
    ...
    ctx.fillStyle = "#4337C8";
    var circlesRy = [];
    var circlesNum = 40;
    var requestId = null;

    function Circle() {
      this.r = randomIntFromInterval(5, 150);
      this.x = randomIntFromInterval(this.r, cw - this.r);
      this.y = randomIntFromInterval(this.r, ch - this.r);

      this.vx = randomIntFromInterval(55, 100)/100;
      this.vy = randomIntFromInterval(55, 100)/100;
  ...
  render() {
    return (
      <canvas id="canvas" ref={ref => (this.mount = ref)}></canvas>
    )
  }
}
